...
SVC_NAME="actions.runner.vinayak432-news-app-devops.ip-172-31-33-129.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (vinayak432-news-app-devops.ip-172-31-33-129)"
